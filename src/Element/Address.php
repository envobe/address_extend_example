...
namespace Drupal\address_extend_example\Element;
...
use Drupal\address_extend_example\AddressFormatHelper;
use Drupal\address_extend_example\AddressField;
use Drupal\address_extend_example\FieldOverrides;
use Drupal\address_extend_example\FieldHelper;
use Drupal\address_extend_example\LabelHelper;
...
class Address extends AddressBase {
  ...
  protected static function addressElements(array $element, array $value) {
    ...
    $address_format = \Drupal::service('address_extend_example.address_format_repository')->get($value['country_code']);
