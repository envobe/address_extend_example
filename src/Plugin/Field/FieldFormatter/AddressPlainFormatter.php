...
namespace Drupal\address_extend_example\Plugin\Field\FieldFormatter;
...
use Drupal\address_extend_example\Repository\AddressFormatRepository;
...
class AddressPlainFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\address_extend_example\Repository\AddressFormatRepository
   */
   ...
   * @param \Drupal\address_extend_example\Repository\AddressFormatRepository $address_format_repository
   *   The address format repository.
   ...
   *   The subdivision repository.
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, $label, $view_mode, array $third_party_settings, AddressFormatRepository $address_format_repository, CountryRepositoryInterface $country_repository, SubdivisionRepositoryInterface $subdivision_repository) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $pluginId, $pluginDefinition) {
    ...
    return new static(
      ...
      $container->get('address_extend_example.address_format_repository'),
